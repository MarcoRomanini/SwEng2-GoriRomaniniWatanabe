...
\begin{description}[font=~\normalfont\scshape]
    \item[\textbf{\textcolor{myblue}{Policy makers needs}}]\label{line:policyMakersPrivileges}
    \hfill \begin{enumerate}[topsep=0pt,leftmargin=0pt]
            ...
            \end{enumerate}
    \item[\textbf{\textcolor{myblue}{Farmers needs}}]\label{line:farmersPrivileges}
    \hfill \begin{enumerate}[topsep=0pt,leftmargin=0pt, resume]
            ...
            \end{enumerate}
    \item[\textbf{\textcolor{myblue}{Agronomist needs}}]\label{line:agronomistPrivileges}
    \hfill \begin{enumerate}[topsep=0pt,leftmargin=0pt, resume]
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|m{0.85\textwidth}|l|}
        ...
        \hline
        G.3                                     &  Policy maker should be able to see the effectiveness of the steering initiatives carried out by farmers and agronomists  &   \hyperref[line:policyMakersPrivileges]{1} \\
        \hline
        G.4                                              &   Policy maker should be able to ask farmers to write good practices      &   \hyperref[line:policyMakersPrivileges]{3} \\
        \hline
        % FARMER GOALS
