...
\begin{table}[H]
    ...
    \begin{tabular}{|l|m{0.85\textwidth}|l|}
        ...
        \hline
        G.3                                     &   Policy maker should be able to ask high performing farmers to write good practices   &   \hyperref[sec:policyMakersNeeds]{1} \\
        \hline
        G.4                                              &   Policy maker should be able to compare the performance difference of farmer between the current data and the past data(before agronomist visits)     &   \hyperref[sec:policyMakersNeeds]{3} \\
        \hline
        % FARMER GOALS
        ...
        \hline
        G.11                                               &     Agronomists should be able to see best performing and under-performing farmers in the area &   \hyperref[sec:agronomistsNeeds]{11} \\
        \hline
...
\begin{center}
    ...
    \begin{longtable}{ll}
        ...
        \hline
        13/12	&	Architecture Structure (Microservices)	\\
        \hline
        15/12	&	BPMN\\
        	&	Alloy code	\\
...
\subsection*{\textsc{\textcolor{myblue}{\ref{sect:overview} Overall description}}}
...
\subsection*{\textsc{\textcolor{myblue}{\ref{sect:requirements} Specific Requirements}}}
...
\subsection*{\textsc{\textcolor{myblue}{\ref{sect:alloy} Formal Analysis using Alloy}}}
Finally in section \ldots
