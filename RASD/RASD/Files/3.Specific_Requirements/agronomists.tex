...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{Images/Sequence diagrams/Agronomist - add area.png}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{\label{tab:responsible_area_removal}Remove an area for an agronomist}
\end{table}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{Images/Sequence diagrams/Agronomist - remove area.png}

    \caption{Remove an area for an agronomist - sequence diagram}
    \label{fig:fig:seq_diag_remove_area}
