...
\begin{table}[H]
    ...
    \begin{tabular}[c]{|l|p{0.75\textwidth}|}
    	...
    	\hline % ---------------------------------------------------------------------
<<<<<<< HEAD
    	\textsc{Name}               &   Insertion of the area an agronomist is responsible of\\
=======
...
\begin{table}[H]
    ...
    \begin{tabular}[c]{|l|p{0.75\textwidth}|}
    	...
    	\hline % ---------------------------------------------------------------------
<<<<<<< HEAD
    	\textsc{Name}               &   Visualize data of the area (weather forecasts, best/under performing farmers, problems encountered by farmers)\\
=======
